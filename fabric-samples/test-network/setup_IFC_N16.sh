...
P7O1_ADDR="localhost:1551"
P7O1_TLS_DIR="${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/tls"
P7O1_TLS="${P7O1_TLS_DIR}/ca.crt"
...
P7O2_ADDR="localhost:2551"
P7O2_TLS_DIR="${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/tls"
P7O2_TLS="${P7O2_TLS_DIR}/ca.crt"
...
# Unique enrollment IDs (avoid collisions with any old 'peer7')
EID_ORG1="peer7org1"
ESECRET_ORG1="peer7org1pw"
EID_ORG2="peer7org2"
ESECRET_ORG2="peer7org2pw"
...
ensure_peer7_org1_material () {
  export FABRIC_CA_CLIENT_HOME="${PWD}/organizations/peerOrganizations/org1.example.com"
  mkdir -p "${P7O1_TLS_DIR}"
  ...
  fabric-ca-client enroll \
    -u "https://${EID_ORG1}:${ESECRET_ORG1}@localhost:7054" \
    --caname ca-org1 \
    -M "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/msp" \
    --csr.hosts "peer7.org1.example.com" \
    --tls.certfiles "${CA_ORG1_TLS}"

  cp "${PWD}/organizations/peerOrganizations/org1.example.com/msp/config.yaml" \
     "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/msp/config.yaml"

  # Enroll TLS
  fabric-ca-client enroll \
    -u "https://${EID_ORG1}:${ESECRET_ORG1}@localhost:7054" \
    --caname ca-org1 \
    -M "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/tls" \
    --enrollment.profile tls \
    --csr.hosts "peer7.org1.example.com" \
    --csr.hosts "localhost" \
    --tls.certfiles "${CA_ORG1_TLS}"

  cp "${P7O1_TLS_DIR}/tlscacerts/"* "${P7O1_TLS_DIR}/ca.crt"
  cp "${P7O1_TLS_DIR}/signcerts/"*  "${P7O1_TLS_DIR}/server.crt"
  cp "${P7O1_TLS_DIR}/keystore/"*  "${P7O1_TLS_DIR}/server.key"
}
...
ensure_peer7_org2_material () {
  export FABRIC_CA_CLIENT_HOME="${PWD}/organizations/peerOrganizations/org2.example.com"
  mkdir -p "${P7O2_TLS_DIR}"
  ...
  fabric-ca-client enroll \
    -u "https://${EID_ORG2}:${ESECRET_ORG2}@localhost:8054" \
    --caname ca-org2 \
    -M "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/msp" \
    --csr.hosts "peer7.org2.example.com" \
    --tls.certfiles "${CA_ORG2_TLS}"

  cp "${PWD}/organizations/peerOrganizations/org2.example.com/msp/config.yaml" \
     "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/msp/config.yaml"

  fabric-ca-client enroll \
    -u "https://${EID_ORG2}:${ESECRET_ORG2}@localhost:8054" \
    --caname ca-org2 \
    -M "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/tls" \
    --enrollment.profile tls \
    --csr.hosts "peer7.org2.example.com" \
    --csr.hosts "localhost" \
    --tls.certfiles "${CA_ORG2_TLS}"

  cp "${P7O2_TLS_DIR}/tlscacerts/"* "${P7O2_TLS_DIR}/ca.crt"
  cp "${P7O2_TLS_DIR}/signcerts/"*  "${P7O2_TLS_DIR}/server.crt"
  cp "${P7O2_TLS_DIR}/keystore/"*  "${P7O2_TLS_DIR}/server.key"
}
...
check_peer_joined "${ORG1_MSP}" "${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" "${P7O1_ADDR}" "${P7O1_TLS}"
...
check_peer_joined "${ORG2_MSP}" "${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" "${P7O2_ADDR}" "${P7O2_TLS}"
...
install_if_needed "${ORG1_MSP}" "${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" "${P7O1_ADDR}" "${P7O1_TLS}"
# Org2
...
install_if_needed "${ORG2_MSP}" "${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" "${P7O2_ADDR}" "${P7O2_TLS}"
...
warmup_peer "Org1MSP" "${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" "localhost:1551" "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/tls/ca.crt"
...
warmup_peer "Org2MSP" "${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" "localhost:2551" "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/tls/ca.crt"
...
peer7org1() { use_peer_env "Org1MSP" "${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" "localhost:1551" "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer7.org1.example.com/tls/ca.crt"; }
...
peer7org2() { use_peer_env "Org2MSP" "${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" "localhost:2551" "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer7.org2.example.com/tls/ca.crt"; }
# Orderer TLS
...
for p in "${P0O1_ADDR},${P0O1_TLS},${ORG1_MSP},${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" \
         ...
         "${P7O1_ADDR},${P7O1_TLS},${ORG1_MSP},${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" \
         ...
         "${P7O2_ADDR},${P7O2_TLS},${ORG2_MSP},${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp"
do
